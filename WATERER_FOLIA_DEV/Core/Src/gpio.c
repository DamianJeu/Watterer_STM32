...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, LED_BLUE_Pin|LED_GREEN_Pin|LED_RED_Pin|DS_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pin : PtPin */
  GPIO_InitStruct.Pin = ENCO_BTN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(ENCO_BTN_GPIO_Port, &GPIO_InitStruct);
